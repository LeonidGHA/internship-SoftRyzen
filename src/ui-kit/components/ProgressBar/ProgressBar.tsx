...
// import { getQuestionNumber, getTotalCount } from 'redux/testingInfo/testingInfoSelectors';
...
//                 <li
//                   key={item}
//                   className={`${s[`progressBar__line`]} ${checkNumber(item)}`}
//                 ></li>
//               ))}
//             </ul>
//             <ICONS.FLAG_ONE
